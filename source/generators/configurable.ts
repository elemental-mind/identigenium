...
export class ConfigurableIDProvider implements IDSource
{
    ...
    constructor(permittedCharacters: string, startEpoch: number = 0, public readonly prefix: string = "")
    {
    ...
    protected *epochUpdatingIdGenerator(startEpoch: number): Generator<string, string, void>
    {
    ...
    protected *idGenerator(startEpoch: number): Generator<string, string, void>
    {
